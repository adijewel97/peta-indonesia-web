...
BEGIN
    ...
    INSERT INTO LISDESBPBL.TRANS_JARINGAN_LISTRIK(
        ...
        latitude, longitude, parent_id, status_lapangan
    ) VALUES (
        '53','53TSK','53221','32','JAWA BARAT','3209','TASIKMALAYA',
        '3209050','CIBALONG','3209050005','KELURAHAN A',
        'T6_1','TIANG','Tiang Beton 12 m','TM',
        -7.3738,108.4962,v_id_g6,'BARU'
    )
    ...
    INSERT INTO LISDESBPBL.TRANS_JARINGAN_LISTRIK(
        ...
        status_lapangan, transmisi
    ) VALUES (
        '53','53TSK','53221','32','JAWA BARAT','3209','TASIKMALAYA',
        '3209050','CIBALONG','3209050005','KELURAHAN A',
        'K_G6_T61_TM','KABEL',v_id_g6,v_id_t61,50,'m','Meter','BARU','TM'
    )
    ...
    INSERT INTO LISDESBPBL.TRANS_JARINGAN_LISTRIK(
        ...
        '53','53TSK','53221','32','JAWA BARAT','3209','TASIKMALAYA',
        '3209050','CIBALONG','3209050005','KELURAHAN A',
        'K_G6_T61_TR','KABEL',v_id_g6,v_id_t61,50,'m','Meter','BARU','TR'
    )
    ...
    INSERT INTO LISDESBPBL.TRANS_JARINGAN_LISTRIK(
        ...
        '53','53TSK','53221','32','JAWA BARAT','3209','TASIKMALAYA',
        '3209050','CIBALONG','3209050005','KELURAHAN A',
        'K_T61_T62_TM','KABEL',v_id_t61,v_id_t62,60,'m','Meter','BARU','TM'
    )
    ...
    INSERT INTO LISDESBPBL.TRANS_JARINGAN_LISTRIK(
        ...
        '53','53TSK','53221','32','JAWA BARAT','3209','TASIKMALAYA',
        '3209050','CIBALONG','3209050005','KELURAHAN A',
        'K_T61_T62_TR','KABEL',v_id_t61,v_id_t62,60,'m','Meter','BARU','TR'
    )
    ...
    INSERT INTO LISDESBPBL.TRANS_JARINGAN_LISTRIK(
        ...
        '53','53TSK','53221','32','JAWA BARAT','3209','TASIKMALAYA',
        '3209050','CIBALONG','3209050005','KELURAHAN A',
        'K_T62_B61_TR','KABEL',v_id_t62,v_id_b61,30,'m','Meter','BARU','TR'
    )
